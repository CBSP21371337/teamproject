      ...
      <NavbarContainer locale={locale}>
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1">
            <NavLink href={'/'}><FormattedMessage tagName="p" id="Navbar.Main" /></NavLink>
            <NavLink href={'/Kontakt'}><FormattedMessage tagName="p" id="Navbar.Contact" /></NavLink>
            <NavLink href={'/Pokoje'}><FormattedMessage tagName="p" id="Navbar.Rooms" /></NavLink>
            <NavLink href={'/FAQ'}><FormattedMessage tagName="p" id="Navbar.FAQ" /></NavLink>
            <NavLink href={'/Grupy'}><FormattedMessage tagName="p" id="Navbar.Groups" /></NavLink>
            <NavLink href={'/Regulamin'}><FormattedMessage tagName="p" id="Navbar.Statue" /></NavLink>
          </ul>
        </div>
      </NavbarContainer>
